...
namespace proyecto
{
    public partial class Modificar_Profesor_Existente : Form
    {
        ...
        private void AplicarDisenoModerno()
        {
            ...
            button4.Size = new Size(110, 34); button4.Location = new Point(163, 8);
            ...
            lblLista.Text = "Selecciona un profesor de la lista";
        ...
        {
            if (idprofesor != null) { idprofesor.ReadOnly = true; idprofesor.BackColor = System.Drawing.Color.LightGray; }
            ...
            apellido_prof.KeyPress += (sender, e) => {
                if (!char.IsControl(e.KeyChar) && !char.IsLetter(e.KeyChar) && !char.IsWhiteSpace(e.KeyChar)) e.Handled = true;
            };
            if (telefono != null)
            {
        ...
        private void ConfigurarComboSexo()
        {
            ...
            cmbSexo.Location = viejo != null ? viejo.Location : new System.Drawing.Point(15, 246);
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            if (!Validaciones.ValidarCamposProfesor(idprofesor.Text, cedprofesional.Text, nombre.Text, apellido_prof.Text, telefono.Text, correo.Text, sexoSeleccionado, esEdicion: true))
                return;
            if (BaseDeDatos.ActualizarProfesor(int.Parse(idprofesor.Text), cedprofesional.Text.Trim().ToUpper(),
